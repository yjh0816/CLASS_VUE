<template>
  <div class="movie">
    ...
    <ol class="list" v-for="movie, index in movies" :key="movie.name">
      <li>
        <a href="">
          ...
          <img class="poster" :src="require(`@/assets/${movie.src}`)" :alt=movie.name />
